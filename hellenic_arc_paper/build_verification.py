...
CLAIM_OVERRIDE = {
    30: "Kopf et al. (2003) ביצעו איזון נפחי בין כמות המשקעים הנצברת לזו "
        "הנבלעת בהפחתה. הניתוח התבסס על ארבעה חתכים סיסמיים לרוחב המנסרה, "
        "שעברו עיבוד של הגירת עומק.",
}
...
def main():
    ...
    fmt(doc.add_paragraph(
        "לכל אחת מ-57 הערות השוליים שבעבודה מובאים כאן המקור, הלוקטור המדויק "

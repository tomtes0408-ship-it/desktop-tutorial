...
ATTRIBUTION = {
    26: "ייחוס מקור לאיור 1 (Wikimedia Commons, CC BY-SA 3.0).",
    41: "ייחוס מקור לאיור 2 (Güneş et al. 2018, איור 21, עמ' 315).",
    51: "ייחוס מקור לאיור 3 (Huguen et al. 2006, איור 4, עמ' 65).",
    59: "הערה ביבליוגרפית: מזהה DOI של Güneş et al. (2018).",
    60: "הערה ביבליוגרפית: מזהה DOI ופורמט המספור של Kopf et al. (2003).",
    61: "הערה ביבליוגרפית: מזהה DOI ופורמט המספור של Royden & Papanikolaou (2011).",
}
